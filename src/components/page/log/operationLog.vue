<template>
    <div class="table">
        ...
        <el-table :data="usersInfo" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="name" label="操作类型" width="120">
            </el-table-column>
            <el-table-column prop="gender" label="操作详情" width="120">
            </el-table-column>
            <el-table-column prop="email" label="操作模块" width="120">
            </el-table-column>
            <el-table-column prop="job" label="访问IP" width="120">
            </el-table-column>
            <el-table-column prop="state" label="访问时间" width="120">
            </el-table-column>
