<template>
    <div class="table">
        ...
        <el-table :data="usersInfo" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
            ...
            <!--</el-table-column>-->
            <el-table-column prop="username" label="用户ID" width="150">
            </el-table-column>
            <el-table-column prop="username" label="IP" width="150">
            </el-table-column>
            <el-table-column prop="name" label="URL" width="150">
            </el-table-column>
            <el-table-column prop="gender" label="访问方法" width="150">
            </el-table-column>
            <el-table-column prop="email" label="访问时间" width="150">
            </el-table-column>
